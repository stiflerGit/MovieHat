...
type ListUserMoviesResponse_MovieStatus_Status int32

const (
	ListUserMoviesResponse_MovieStatus_STATUS_UNSPECIFIED ListUserMoviesResponse_MovieStatus_Status = 0
	ListUserMoviesResponse_MovieStatus_STATUS_PENDING     ListUserMoviesResponse_MovieStatus_Status = 1
	ListUserMoviesResponse_MovieStatus_STATUS_WATCHED     ListUserMoviesResponse_MovieStatus_Status = 2
)

// Enum value maps for ListUserMoviesResponse_MovieStatus_Status.
var (
	ListUserMoviesResponse_MovieStatus_Status_name = map[int32]string{
		0: "STATUS_UNSPECIFIED",
		1: "STATUS_PENDING",
		2: "STATUS_WATCHED",
	}
	ListUserMoviesResponse_MovieStatus_Status_value = map[string]int32{
...
func (x ListUserMoviesResponse_MovieStatus_Status) Enum() *ListUserMoviesResponse_MovieStatus_Status {
	p := new(ListUserMoviesResponse_MovieStatus_Status)
	*p = x
	return p
}

func (x ListUserMoviesResponse_MovieStatus_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ListUserMoviesResponse_MovieStatus_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_gateway_v1_gateway_proto_enumTypes[0].Descriptor()
}

func (ListUserMoviesResponse_MovieStatus_Status) Type() protoreflect.EnumType {
	return &file_gateway_v1_gateway_proto_enumTypes[0]
}

func (x ListUserMoviesResponse_MovieStatus_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ListUserMoviesResponse_MovieStatus_Status.Descriptor instead.
func (ListUserMoviesResponse_MovieStatus_Status) EnumDescriptor() ([]byte, []int) {
	return file_gateway_v1_gateway_proto_rawDescGZIP(), []int{40, 0, 0}
}
...
func (x *AddUserMovieRequest) GetMovieId() string {
	if x != nil {
		return x.MovieId
	}
	return ""
...
type ListUserMoviesResponse struct {
	state         protoimpl.MessageState                `protogen:"open.v1"`
	Movies        []*ListUserMoviesResponse_MovieStatus `protobuf:"bytes,1,rep,name=movies,proto3" json:"movies,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListUserMoviesResponse) GetMovies() []*ListUserMoviesResponse_MovieStatus {
	if x != nil {
		return x.Movies
	}
	return nil
...
type ListUserMoviesResponse_MovieStatus struct {
	state         protoimpl.MessageState                    `protogen:"open.v1"`
	Movie         *Movie                                    `protobuf:"bytes,1,opt,name=movie,proto3" json:"movie,omitempty"`
	Status        ListUserMoviesResponse_MovieStatus_Status `protobuf:"varint,2,opt,name=status,proto3,enum=gateway.v1.ListUserMoviesResponse_MovieStatus_Status" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListUserMoviesResponse_MovieStatus) Reset() {
	*x = ListUserMoviesResponse_MovieStatus{}
	mi := &file_gateway_v1_gateway_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListUserMoviesResponse_MovieStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListUserMoviesResponse_MovieStatus) ProtoMessage() {}

func (x *ListUserMoviesResponse_MovieStatus) ProtoReflect() protoreflect.Message {
	mi := &file_gateway_v1_gateway_proto_msgTypes[46]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListUserMoviesResponse_MovieStatus.ProtoReflect.Descriptor instead.
func (*ListUserMoviesResponse_MovieStatus) Descriptor() ([]byte, []int) {
	return file_gateway_v1_gateway_proto_rawDescGZIP(), []int{40, 0}
}

func (x *ListUserMoviesResponse_MovieStatus) GetMovie() *Movie {
	if x != nil {
		return x.Movie
	}
	return nil
...
func (x *ListUserMoviesResponse_MovieStatus) GetStatus() ListUserMoviesResponse_MovieStatus_Status {
	if x != nil {
		return x.Status
	}
	return ListUserMoviesResponse_MovieStatus_STATUS_UNSPECIFIED
}

type SearchMovieResponse_Result struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Title         string                 `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"`
	ReleaseDate   *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=release_date,json=releaseDate,proto3" json:"release_date,omitempty"`
...
func (x *SearchMovieResponse_Result) Reset() {
	*x = SearchMovieResponse_Result{}
	mi := &file_gateway_v1_gateway_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SearchMovieResponse_Result) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchMovieResponse_Result) ProtoMessage() {}

func (x *SearchMovieResponse_Result) ProtoReflect() protoreflect.Message {
	mi := &file_gateway_v1_gateway_proto_msgTypes[47]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchMovieResponse_Result.ProtoReflect.Descriptor instead.
func (*SearchMovieResponse_Result) Descriptor() ([]byte, []int) {
	return file_gateway_v1_gateway_proto_rawDescGZIP(), []int{44, 0}
}

func (x *SearchMovieResponse_Result) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *SearchMovieResponse_Result) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *SearchMovieResponse_Result) GetReleaseDate() *timestamppb.Timestamp {
	if x != nil {
		return x.ReleaseDate
	}
	return nil
...
func (x *SearchMovieResponse_Result) GetPosterPath() string {
	if x != nil {
		return x.PosterPath
	}
	return ""
...
const file_gateway_v1_gateway_proto_rawDesc = "" +
	...
	"\fparticipants\x18\x01 \x03(\v2\x10.gateway.v1.UserR\fparticipants\"P\n" +
	"\x13AddUserMovieRequest\x12%\n" +
	"\bmovie_id\x18\x01 \x01(\tB\n" +
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\amovieId\x12\x12\n" +
	"\x04note\x18\x02 \x01(\tR\x04note\"\x8d\x01\n" +
	"\x05Movie\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12=\n" +
	"\frelease_date\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\vreleaseDate\x12\x1f\n" +
	...
	"\xbaH\a\xc8\x01\x01r\x02\x10\x01R\x06userId\"\xb2\x02\n" +
	"\x16ListUserMoviesResponse\x12F\n" +
	"\x06movies\x18\x01 \x03(\v2..gateway.v1.ListUserMoviesResponse.MovieStatusR\x06movies\x1a\xcf\x01\n" +
	"\vMovieStatus\x12'\n" +
	"\x05movie\x18\x01 \x01(\v2\x11.gateway.v1.MovieR\x05movie\x12M\n" +
	"\x06status\x18\x02 \x01(\x0e25.gateway.v1.ListUserMoviesResponse.MovieStatus.StatusR\x06status\"H\n" +
	"\x06Status\x12\x16\n" +
	"\x12STATUS_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eSTATUS_PENDING\x10\x01\x12\x12\n" +
	"\x0eSTATUS_WATCHED\x10\x02\"4\n" +
	...
	"\x0fDeleteUserMovie\x12\".gateway.v1.DeleteUserMovieRequest\x1a#.gateway.v1.DeleteUserMovieResponse\x12N\n" +
	"\vSearchMovie\x12\x1e.gateway.v1.SearchMovieRequest\x1a\x1f.gateway.v1.SearchMovieResponseB\xa0\x01\n" +
...
var file_gateway_v1_gateway_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_gateway_v1_gateway_proto_goTypes = []any{
	(ListUserMoviesResponse_MovieStatus_Status)(0),                   // 0: gateway.v1.ListUserMoviesResponse.MovieStatus.Status
	(*CreateInvitationRequest)(nil),                                  // 1: gateway.v1.CreateInvitationRequest
	(*CreateInvitationResponse)(nil),                                 // 2: gateway.v1.CreateInvitationResponse
	(*SignUpRequest)(nil),                                            // 3: gateway.v1.SignUpRequest
	(*SignUpResponse)(nil),                                           // 4: gateway.v1.SignUpResponse
	(*SignInRequest)(nil),                                            // 5: gateway.v1.SignInRequest
	(*SignInResponse)(nil),                                           // 6: gateway.v1.SignInResponse
	(*SignOutRequest)(nil),                                           // 7: gateway.v1.SignOutRequest
	(*SignOutResponse)(nil),                                          // 8: gateway.v1.SignOutResponse
	(*User)(nil),                                                     // 9: gateway.v1.User
	(*ListUsersRequest)(nil),                                         // 10: gateway.v1.ListUsersRequest
	(*ListUsersResponse)(nil),                                        // 11: gateway.v1.ListUsersResponse
	(*UpdateUserRequest)(nil),                                        // 12: gateway.v1.UpdateUserRequest
	(*UpdateUserResponse)(nil),                                       // 13: gateway.v1.UpdateUserResponse
	(*DeleteUserRequest)(nil),                                        // 14: gateway.v1.DeleteUserRequest
	(*DeleteUserResponse)(nil),                                       // 15: gateway.v1.DeleteUserResponse
	(*CreateSessionRequest)(nil),                                     // 16: gateway.v1.CreateSessionRequest
	(*CreateSessionResponse)(nil),                                    // 17: gateway.v1.CreateSessionResponse
	(*Session)(nil),                                                  // 18: gateway.v1.Session
	(*ListSessionsRequest)(nil),                                      // 19: gateway.v1.ListSessionsRequest
	(*ListSessionsResponse)(nil),                                     // 20: gateway.v1.ListSessionsResponse
	(*GetSessionRequest)(nil),                                        // 21: gateway.v1.GetSessionRequest
	(*GetSessionResponse)(nil),                                       // 22: gateway.v1.GetSessionResponse
	(*EndSessionRequest)(nil),                                        // 23: gateway.v1.EndSessionRequest
	(*EndSessionResponse)(nil),                                       // 24: gateway.v1.EndSessionResponse
	(*SetSessionMovieRequest)(nil),                                   // 25: gateway.v1.SetSessionMovieRequest
	(*SetSessionMovieResponse)(nil),                                  // 26: gateway.v1.SetSessionMovieResponse
	(*GetSessionProbabilitiesRequest)(nil),                           // 27: gateway.v1.GetSessionProbabilitiesRequest
	(*GetSessionProbabilitiesResponse)(nil),                          // 28: gateway.v1.GetSessionProbabilitiesResponse
	(*DeleteSessionRequest)(nil),                                     // 29: gateway.v1.DeleteSessionRequest
	(*DeleteSessionResponse)(nil),                                    // 30: gateway.v1.DeleteSessionResponse
	(*AddParticipantRequest)(nil),                                    // 31: gateway.v1.AddParticipantRequest
	(*AddParticipantResponse)(nil),                                   // 32: gateway.v1.AddParticipantResponse
	(*RemoveParticipantRequest)(nil),                                 // 33: gateway.v1.RemoveParticipantRequest
	(*RemoveParticipantResponse)(nil),                                // 34: gateway.v1.RemoveParticipantResponse
	(*ListParticipantsRequest)(nil),                                  // 35: gateway.v1.ListParticipantsRequest
	(*ListParticipantsResponse)(nil),                                 // 36: gateway.v1.ListParticipantsResponse
	(*AddUserMovieRequest)(nil),                                      // 37: gateway.v1.AddUserMovieRequest
	(*Movie)(nil),                                                    // 38: gateway.v1.Movie
	(*AddUserMovieResponse)(nil),                                     // 39: gateway.v1.AddUserMovieResponse
	(*ListUserMoviesRequest)(nil),                                    // 40: gateway.v1.ListUserMoviesRequest
	(*ListUserMoviesResponse)(nil),                                   // 41: gateway.v1.ListUserMoviesResponse
	(*DeleteUserMovieRequest)(nil),                                   // 42: gateway.v1.DeleteUserMovieRequest
	(*DeleteUserMovieResponse)(nil),                                  // 43: gateway.v1.DeleteUserMovieResponse
	(*SearchMovieRequest)(nil),                                       // 44: gateway.v1.SearchMovieRequest
	(*SearchMovieResponse)(nil),                                      // 45: gateway.v1.SearchMovieResponse
	(*GetSessionProbabilitiesResponse_ParticipantProbabilities)(nil), // 46: gateway.v1.GetSessionProbabilitiesResponse.ParticipantProbabilities
	(*ListUserMoviesResponse_MovieStatus)(nil),                       // 47: gateway.v1.ListUserMoviesResponse.MovieStatus
	(*SearchMovieResponse_Result)(nil),                               // 48: gateway.v1.SearchMovieResponse.Result
	(*timestamppb.Timestamp)(nil),                                    // 49: google.protobuf.Timestamp
}
var file_gateway_v1_gateway_proto_depIdxs = []int32{
	49, // 0: gateway.v1.CreateInvitationResponse.expires_at:type_name -> google.protobuf.Timestamp
	9,  // 1: gateway.v1.ListUsersResponse.users:type_name -> gateway.v1.User
	9,  // 2: gateway.v1.UpdateUserResponse.user:type_name -> gateway.v1.User
	9,  // 3: gateway.v1.DeleteUserResponse.user:type_name -> gateway.v1.User
	18, // 4: gateway.v1.CreateSessionResponse.session:type_name -> gateway.v1.Session
	49, // 5: gateway.v1.Session.created_at:type_name -> google.protobuf.Timestamp
	49, // 6: gateway.v1.Session.closed_at:type_name -> google.protobuf.Timestamp
	9,  // 7: gateway.v1.Session.participants:type_name -> gateway.v1.User
	9,  // 8: gateway.v1.Session.winner:type_name -> gateway.v1.User
	18, // 9: gateway.v1.ListSessionsResponse.sessions:type_name -> gateway.v1.Session
	18, // 10: gateway.v1.GetSessionResponse.session:type_name -> gateway.v1.Session
	9,  // 11: gateway.v1.EndSessionResponse.winner:type_name -> gateway.v1.User
	46, // 12: gateway.v1.GetSessionProbabilitiesResponse.participants_probabilities:type_name -> gateway.v1.GetSessionProbabilitiesResponse.ParticipantProbabilities
	18, // 13: gateway.v1.DeleteSessionResponse.session:type_name -> gateway.v1.Session
	9,  // 14: gateway.v1.ListParticipantsResponse.participants:type_name -> gateway.v1.User
	49, // 15: gateway.v1.Movie.release_date:type_name -> google.protobuf.Timestamp
	38, // 16: gateway.v1.AddUserMovieResponse.movie:type_name -> gateway.v1.Movie
	47, // 17: gateway.v1.ListUserMoviesResponse.movies:type_name -> gateway.v1.ListUserMoviesResponse.MovieStatus
	48, // 18: gateway.v1.SearchMovieResponse.results:type_name -> gateway.v1.SearchMovieResponse.Result
	38, // 19: gateway.v1.ListUserMoviesResponse.MovieStatus.movie:type_name -> gateway.v1.Movie
	0,  // 20: gateway.v1.ListUserMoviesResponse.MovieStatus.status:type_name -> gateway.v1.ListUserMoviesResponse.MovieStatus.Status
	49, // 21: gateway.v1.SearchMovieResponse.Result.release_date:type_name -> google.protobuf.Timestamp
	1,  // 22: gateway.v1.GatewayService.CreateInvitation:input_type -> gateway.v1.CreateInvitationRequest
	3,  // 23: gateway.v1.GatewayService.SignUp:input_type -> gateway.v1.SignUpRequest
	5,  // 24: gateway.v1.GatewayService.SignIn:input_type -> gateway.v1.SignInRequest
	7,  // 25: gateway.v1.GatewayService.SignOut:input_type -> gateway.v1.SignOutRequest
	10, // 26: gateway.v1.GatewayService.ListUsers:input_type -> gateway.v1.ListUsersRequest
	12, // 27: gateway.v1.GatewayService.UpdateUser:input_type -> gateway.v1.UpdateUserRequest
	14, // 28: gateway.v1.GatewayService.DeleteUser:input_type -> gateway.v1.DeleteUserRequest
	16, // 29: gateway.v1.GatewayService.CreateSession:input_type -> gateway.v1.CreateSessionRequest
	19, // 30: gateway.v1.GatewayService.ListSessions:input_type -> gateway.v1.ListSessionsRequest
	21, // 31: gateway.v1.GatewayService.GetSession:input_type -> gateway.v1.GetSessionRequest
	23, // 32: gateway.v1.GatewayService.EndSession:input_type -> gateway.v1.EndSessionRequest
	25, // 33: gateway.v1.GatewayService.SetSessionMovie:input_type -> gateway.v1.SetSessionMovieRequest
	27, // 34: gateway.v1.GatewayService.GetSessionProbabilities:input_type -> gateway.v1.GetSessionProbabilitiesRequest
	29, // 35: gateway.v1.GatewayService.DeleteSession:input_type -> gateway.v1.DeleteSessionRequest
	31, // 36: gateway.v1.GatewayService.AddParticipant:input_type -> gateway.v1.AddParticipantRequest
	33, // 37: gateway.v1.GatewayService.RemoveParticipant:input_type -> gateway.v1.RemoveParticipantRequest
	35, // 38: gateway.v1.GatewayService.ListParticipants:input_type -> gateway.v1.ListParticipantsRequest
	37, // 39: gateway.v1.GatewayService.AddUserMovie:input_type -> gateway.v1.AddUserMovieRequest
	40, // 40: gateway.v1.GatewayService.ListUserMovies:input_type -> gateway.v1.ListUserMoviesRequest
	42, // 41: gateway.v1.GatewayService.DeleteUserMovie:input_type -> gateway.v1.DeleteUserMovieRequest
	44, // 42: gateway.v1.GatewayService.SearchMovie:input_type -> gateway.v1.SearchMovieRequest
	2,  // 43: gateway.v1.GatewayService.CreateInvitation:output_type -> gateway.v1.CreateInvitationResponse
	4,  // 44: gateway.v1.GatewayService.SignUp:output_type -> gateway.v1.SignUpResponse
	6,  // 45: gateway.v1.GatewayService.SignIn:output_type -> gateway.v1.SignInResponse
	8,  // 46: gateway.v1.GatewayService.SignOut:output_type -> gateway.v1.SignOutResponse
	11, // 47: gateway.v1.GatewayService.ListUsers:output_type -> gateway.v1.ListUsersResponse
	13, // 48: gateway.v1.GatewayService.UpdateUser:output_type -> gateway.v1.UpdateUserResponse
	15, // 49: gateway.v1.GatewayService.DeleteUser:output_type -> gateway.v1.DeleteUserResponse
	17, // 50: gateway.v1.GatewayService.CreateSession:output_type -> gateway.v1.CreateSessionResponse
	20, // 51: gateway.v1.GatewayService.ListSessions:output_type -> gateway.v1.ListSessionsResponse
	22, // 52: gateway.v1.GatewayService.GetSession:output_type -> gateway.v1.GetSessionResponse
	24, // 53: gateway.v1.GatewayService.EndSession:output_type -> gateway.v1.EndSessionResponse
	26, // 54: gateway.v1.GatewayService.SetSessionMovie:output_type -> gateway.v1.SetSessionMovieResponse
	28, // 55: gateway.v1.GatewayService.GetSessionProbabilities:output_type -> gateway.v1.GetSessionProbabilitiesResponse
	30, // 56: gateway.v1.GatewayService.DeleteSession:output_type -> gateway.v1.DeleteSessionResponse
	32, // 57: gateway.v1.GatewayService.AddParticipant:output_type -> gateway.v1.AddParticipantResponse
	34, // 58: gateway.v1.GatewayService.RemoveParticipant:output_type -> gateway.v1.RemoveParticipantResponse
	36, // 59: gateway.v1.GatewayService.ListParticipants:output_type -> gateway.v1.ListParticipantsResponse
	39, // 60: gateway.v1.GatewayService.AddUserMovie:output_type -> gateway.v1.AddUserMovieResponse
	41, // 61: gateway.v1.GatewayService.ListUserMovies:output_type -> gateway.v1.ListUserMoviesResponse
	43, // 62: gateway.v1.GatewayService.DeleteUserMovie:output_type -> gateway.v1.DeleteUserMovieResponse
	45, // 63: gateway.v1.GatewayService.SearchMovie:output_type -> gateway.v1.SearchMovieResponse
