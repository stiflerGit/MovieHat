...
func TestProvider_SearchMovies(t *testing.T) {
	...
	ret, err := p.SearchMovies(t.Context(), moviesearch.SearchMoviesArg{Query: "Fight Club", Offset: 0, Limit: 200})
...
func TestProvider_SearchMovies_HTTPError(t *testing.T) {
	...
	_, err := p.SearchMovies(t.Context(), moviesearch.SearchMoviesArg{Query: "xyz", Limit: 10})
	require.Error(t, err)
}
...
func TestProvider_SearchMovies_NilJSON(t *testing.T) {
	...
	_, err := p.SearchMovies(t.Context(), moviesearch.SearchMoviesArg{Query: "test", Limit: 10})
	require.Error(t, err)
}
